...
/** Brand marks for share / profile links. Lucide v1 dropped brand icons. */
...
export function GitHubIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden {...props}>
      {/* Canonical Octocat path. The mark carries a lot of fine detail, so a
          rounded-down copy loses the tail and the head reads as a blob. */}
